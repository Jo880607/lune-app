...
const PixelMoonSmall = ({ size = 14 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 16 16" style={{ imageRendering: 'pixelated' }}>
    <rect x="5" y="1" width="1" height="1" fill="var(--yellow)" />
    <rect x="6" y="1" width="1" height="1" fill="var(--yellow)" />
    <rect x="7" y="1" width="1" height="1" fill="var(--yellow)" />
    <rect x="8" y="1" width="1" height="1" fill="var(--yellow)" />
    <rect x="4" y="2" width="1" height="1" fill="var(--yellow)" />
    <rect x="9" y="2" width="1" height="1" fill="var(--yellow)" />
    <rect x="3" y="3" width="1" height="1" fill="var(--yellow)" />
    <rect x="10" y="3" width="1" height="1" fill="var(--yellow)" />
    <rect x="2" y="4" width="1" height="1" fill="var(--yellow)" />
    <rect x="2" y="5" width="1" height="1" fill="var(--yellow)" />
    <rect x="2" y="6" width="1" height="1" fill="var(--yellow)" />
    <rect x="2" y="7" width="1" height="1" fill="var(--yellow)" />
    <rect x="2" y="8" width="1" height="1" fill="var(--yellow)" />
    <rect x="2" y="9" width="1" height="1" fill="var(--yellow)" />
    <rect x="2" y="10" width="1" height="1" fill="var(--yellow)" />
    <rect x="3" y="11" width="1" height="1" fill="var(--yellow)" />
    <rect x="4" y="12" width="1" height="1" fill="var(--yellow)" />
    <rect x="5" y="13" width="1" height="1" fill="var(--yellow)" />
    <rect x="6" y="13" width="1" height="1" fill="var(--yellow)" />
    <rect x="7" y="13" width="1" height="1" fill="var(--yellow)" />
    <rect x="8" y="13" width="1" height="1" fill="var(--yellow)" />
    <rect x="9" y="13" width="1" height="1" fill="var(--yellow)" />
    <rect x="5" y="2" width="1" height="1" fill="#FFF8DC" />
    <rect x="6" y="2" width="1" height="1" fill="#FFF8DC" />
    <rect x="4" y="3" width="1" height="1" fill="#FFF8DC" />
    <rect x="5" y="3" width="1" height="1" fill="#FFF8DC" />
